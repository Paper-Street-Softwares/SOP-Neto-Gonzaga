        ...
        <Navbar>
          ...
          >
            <img
              ...
              className={`${
                scrolling
                  ? "w-[40%] tablet1:w-[40%] tablet2:w-[40%] desktop1:w-[40%] desktop2:w-[50%] transition-all duration-1000 "
                  : "my-[20px] w-[50%] phone3:w-[50%] tablet1:w-[60%] tablet2:w-[70%] desktop1:w-[60%] desktop2:w-[70%] transition-all duration-1000 "
              } tablet3:mb-0`}
            />
          </ScrollLink>
