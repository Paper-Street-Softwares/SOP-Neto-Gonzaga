    ...
    >
      {animation ? (
        ...
        <div className="w-auto">
          <button
            onClick={onClick}
            className={`flex ${className} ${sizeFeatures} shadow-custom-opacityButton shadow-shadowHero/0 outline-none bg-buttonColor flex-row items-center justify-around transition ${color} text-labelButtons desktop1:hover:scale-110`}
          >
            <div
              className={`flex items-center text-center ${gap} min-h-[24px]`}
            >
